...
const SkeletonShimmer = ({
  ...
  return (
    <div
      className={`${height} ${width} ${className} relative overflow-hidden bg-light-secondary-background dark:bg-dark-secondary-background rounded-lg`}
    >
      <motion.div
...
const LoadingSkeleton = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      component: <ComparisonSectionSkeleton />,
    },
